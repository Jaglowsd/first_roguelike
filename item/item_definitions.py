...
straight_sword =   {
					'equip_component': ['main hand', 0, 0, 3, 1, None, [5, 2, 1]],
					'weapon_comp': [5, 0, 0, 0, 0, 'straight sword'],
					'armor_comp': None,
					'object': ['Straight Sword', '/', libtcod.sky, '', True]}
dagger = 		   {			
					'equip_component': ['main hand', 0, 0, 2, 1, None, [1, 1, 1]],
					'weapon_comp': [3, 0, 0, 0, 0, 'dagger'],
					'armor_comp': None,
					'object': ['Dagger', '-', libtcod.sky, '', True]}
orcs_right_arm =   {
					'equip_component': ['main hand', 0, 0, 4, 1, None, [4, 1, 1]],
					'weapon_comp': [4, 0, 0, 0, 0, 'club'],
					'armor_comp': None,
					'object': ['Orc\'s Right Arm', 'R', libtcod.light_green, '', True]}
club = 			   {
					'equip_component': ['main hand', 0, 0, 6, 1, None, [10, 1, 1]],
					'weapon_comp': [8, 0, 0, 0, 0, 'club'],
					'armor_comp': None,
